...
|---|---|---|---|
| Русскоязычная hardness-диагностика LLM и output-протокола | `synthetic proof` + локальные model runs: [ru-hardness-30](https://github.com/Absamad-dew/ru-hardness-30), [план и ограничения](https://github.com/Absamad-dew/ru-hardness-30/blob/main/IMPROVEMENT_PLAN.md), [CI](https://github.com/Absamad-dew/ru-hardness-30/actions) | 30 оригинальных сбалансированных кейсов, детерминированный scorer, строгий/нормализованный protocol audit; в одном Ornith 1.0 9B setup лимит 512→768 исправил четыре обрезанных ответа и поднял raw overall `0.4527→0.5481` | Репрезентативность production-трафика, перенос на другие runtime/quantization и качество исходных BF16-весов; выборка мала и использует один seed |
